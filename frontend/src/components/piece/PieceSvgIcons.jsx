    ...
    <PieceSvgBase color={color} size={size} className={className}>
      {({ fill, stroke }) => (
        <>
          ...
          />
          <path
            d="M24 36 C20 42 16 50 18 56 C20 60 24 58 26 54"
            fill="none"
            stroke={stroke}
            strokeWidth="3"
            strokeLinecap="round"
          ...
          />
          <path
            d="M48 26 C44 22 38 24 40 34 C42 38 46 36 48 32"
            fill={fill}
            stroke={stroke}
            strokeWidth="2"
            strokeLinejoin="round"
    ...
    <PieceSvgBase color={color} size={size} className={className}>
      {({ fill, stroke }) => (
        <>
          ...
          <path
            d="M54 22 C50 26 48 32 50 38 M52 24 C48 28 46 34 48 40"
            fill="none"
            stroke={stroke}
            strokeWidth="2"
            strokeLinecap="round"
          />
          <path
            d="M30 50 C26 48 22 50 20 56 C18 60 20 64 24 62"
            fill="none"
            stroke={stroke}
            strokeWidth="2.5"
            strokeLinecap="round"
    ...
    <PieceSvgBase color={color} size={size} className={className}>
      {({ fill, stroke }) => (
        <>
          ...
          <path
            d="M50 42 L58 46 L58 54 C58 58 54 62 50 64 C46 62 42 58 42 54 L42 46 Z"
            fill={fill}
            stroke={stroke}
            strokeWidth="2"
            strokeLinejoin="round"
    ...
    <PieceSvgBase color={color} size={size} className={className}>
      {({ fill, stroke }) => (
        <>
          ...
          />
          <path
            d="M26 52 C22 50 18 52 18 58 C18 62 22 60 24 58"
            fill="none"
            stroke={stroke}
            strokeWidth="2"
            strokeLinecap="round"
    ...
    <PieceSvgBase color={color} size={size} className={className}>
      {({ fill, stroke }) => (
        <>
          ...
          <path
            d="M48 18 C44 22 42 28 44 34 M46 20 C42 24 40 30 42 36 M44 22 C40 26 38 32 40 38"
            fill="none"
            stroke={stroke}
            strokeWidth="1.8"
            strokeLinecap="round"
    ...
    <PieceSvgBase color={color} size={size} className={className}>
      {({ fill, stroke }) => (
        <>
          ...
          />
          <path
            d="M50 16 C48 12 52 12 50 16 C50 10 50 10 50 16"
            fill="none"
            stroke={stroke}
            strokeWidth="2"
            strokeLinecap="round"
          />
          <path
            d="M38 40 L42 36 L50 38 L58 36 L62 40 L66 62 L34 62 Z"
            fill={fill}
            stroke={stroke}
            strokeWidth="2.5"
            strokeLinejoin="round"
          />
          <path
            d="M46 46 L50 44 L54 46 L54 52 L50 54 L46 52 Z"
            fill="none"
            stroke={stroke}
            strokeWidth="1.5"
            strokeLinejoin="round"
    ...
    <PieceSvgBase color={color} size={size} className={className}>
      {({ fill, stroke }) => (
        <>
          ...
          />
          <path
            d="M24 36 L16 40 L14 44 L22 44 L24 42"
            fill={fill}
            stroke={stroke}
            strokeWidth="2"
            strokeLinejoin="round"
          ...
          <path
            d="M24 52 C18 48 14 50 12 56 C10 62 14 66 20 62"
            fill="none"
            stroke={stroke}
            strokeWidth="2.5"
            strokeLinecap="round"
    ...
    <PieceSvgBase color={color} size={size} className={className}>
      {({ fill, stroke }) => (
        <>
          ...
          />
          <path
            d="M50 36 C48 28 48 18 50 12 C52 8 56 10 54 16 C52 22 52 30 52 36"
            fill={fill}
            stroke={stroke}
            strokeWidth="2.5"
            strokeLinejoin="round"
  ...
  return (
    <PieceSvgBase color={color} size={size} className={className}>
      {({ fill, stroke }) => (
        <>
          <path
            d="M30 70 L34 42 L24 50 L50 28 L76 50 L66 42 L70 70 Z"
            fill={fill}
            stroke={stroke}
            strokeWidth="2.5"
            strokeLinejoin="round"
  ...
  return (
    <PieceSvgBase color={color} size={size} className={className}>
      {({ fill, stroke }) => (
        <>
          <path
            d="M50 12 L56 40 L88 50 L56 60 L50 88 L44 60 L12 50 L44 40 Z"
            fill={fill}
            stroke={stroke}
            strokeWidth="2.5"
            strokeLinejoin="round"
...
export function SagittariusIcon({
  color = "WHITE",
  size = 40,
  className = "",
}) {
    ...
    <PieceSvgBase color={color} size={size} className={className}>
      {({ fill, stroke }) => (
        <>
          ...
          />
          <path
            d="M52 28 C52 22 60 20 64 24 C68 28 68 34 66 36"
            fill={fill}
            stroke={stroke}
            strokeWidth="2"
            strokeLinejoin="round"
          />
          <path
            d="M24 34 C20 30 14 28 12 32 C10 36 14 40 18 38"
            fill={fill}
            stroke={stroke}
            strokeWidth="2"
            strokeLinejoin="round"
    ...
    <PieceSvgBase color={color} size={size} className={className}>
      {({ fill, stroke }) => (
        <>
          ...
          <path
            d="M14 32 C8 28 4 32 8 36 C4 36 6 42 12 40"
            fill="none"
            stroke={stroke}
            strokeWidth="1.5"
            strokeLinecap="round"
    ...
    <PieceSvgBase color={color} size={size} className={className}>
      {({ fill, stroke }) => (
        <>
          ...
          />
          <path
            d="M38 42 L36 60 C36 64 40 68 44 68 L56 68 C60 68 64 64 64 60 L62 42"
            fill={fill}
            stroke={stroke}
            strokeWidth="2.5"
            strokeLinejoin="round"
          />
          <path
            d="M38 56 C30 52 24 56 24 64 C24 70 30 72 34 68"
            fill="none"
            stroke={stroke}
            strokeWidth="2.5"
            strokeLinecap="round"
    ...
    <PieceSvgBase color={color} size={size} className={className}>
      {({ fill, stroke }) => (
        <>
          ...
          />
          <path
            d="M26 52 C20 44 14 38 10 34 C6 30 2 32 4 38 C2 44 8 50 14 50 C18 50 22 48 24 46"
            fill={fill}
            stroke={stroke}
            strokeWidth="2.5"
            strokeLinecap="round"
  ...
  return (
    <PieceSvgBase color={color} size={size} className={className}>
      {({ fill, stroke }) => (
        <>
          <path
            d="M50 80 C30 80 16 70 16 56 C16 42 30 32 44 32 C58 32 70 40 70 54 C70 68 58 78 46 78 C34 78 26 70 26 60 C26 50 34 44 44 44 C54 44 62 50 62 58 C62 66 56 72 48 72"
            fill="none"
            stroke={stroke}
            strokeWidth="4"
            strokeLinecap="round"
